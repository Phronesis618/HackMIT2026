...
export const sampleSnapshot: GameSnapshot = {
  ...
  players: [
    {
      ...
      qCooldownMs: 0,
      eCooldownMs: 3200,
      unlockedAbilityIds: ['attack', 'dash', 'bastion.q.bulwark', 'bastion.e.shockwave'],
      shieldMs: 900,
      shieldFacing: 0,
      shards: 16,
      interactProgress: 0,
    ...
    },
    {
      ...
      qCooldownMs: 0,
      eCooldownMs: 0,
      unlockedAbilityIds: ['attack', 'dash', 'shade.q.blink_strike'],
      shieldMs: 0,
      shieldFacing: 0,
      shards: 8,
      interactProgress: 0,
  ...
  enemies: [
    { id: 'sample-enemy-1', enemyId: 'husk', ...tileToWorld(15, 4), facing: Math.PI, hp: 30, maxHp: 30, state: 'attacking', stateMs: 210, windupMs: 420 },
    { id: 'sample-enemy-2', enemyId: 'husk', ...tileToWorld(17, 9), facing: Math.PI, hp: 12, maxHp: 30, state: 'hit', stateMs: 40, windupMs: 0 },
  ],
  anchor: null,
  roomStatus: { cleared: false, enemiesRemaining: 2, exitsLocked: true, objective: 'Clear 2 hostiles to unlock the exit.' },
  run: { runId: 'sample-run-1', status: 'active', roomsCleared: 0, shardsEarned: 24, returnCountdownMs: 0 },
};
...
export const sampleEvents: GameEvent[] = [
  ...
  { id: '300:0', type: 'player_damaged', tick: 300, timeMs: 5000, playerId: 'sample-player-local', amount: 18, remainingHp: 82, sourceEnemyId: 'sample-enemy-1' },
  {
    ...
    timeMs: 6000,
    playerId: 'sample-player-local',
    abilityId: 'bastion.q.bulwark',
    ...tileToWorld(14, 4),
    facing: 0,
    targetEnemyIds: [],
  },
  { id: '380:0', type: 'attack_blocked', tick: 380, timeMs: 6333, playerId: 'sample-player-local', enemyId: 'sample-enemy-1' },
