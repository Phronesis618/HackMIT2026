...
export const THEMES: ThemeDef[] = [
  ...
  {
    id: 'hive',
    keywords: ['hive', 'bee', 'wasp', 'honey', 'insect', 'ant', 'chitin', 'larva', 'larvae', 'nest', 'colony', 'drone', 'comb', 'termite', 'beetle', 'cocoon', 'brood', 'queen', 'swarm', 'mantis', 'moth'],
    motifs: ['roots', 'arches', 'lanterns', 'monoliths'],
    palette: { background: '#140f06', floor: '#3a2a10', floorAlt: '#443214', wall: '#5a4218', wallEdge: '#f2b134', accent: '#ffcf4a', accentSoft: '#8fe0a0', glow: '#ffe28a', hazard: '#ff7a3d', text: '#fff4dc' },
    adjectives: ['Waxen', 'Humming', 'Six-Sided', 'Brood-Warm', 'Amber'],
    nouns: ['Hive', 'Comb', 'Brood-Hall', 'Nursery', 'Cell'],
    taglines: ['A hive built over a station in 40 days, and the station is still in there.', 'Six-sided cells, 12,000 of them, and something is sealed in every ninth.', 'The honey is warm and the workers have 6 legs too many.'],
    summary: 'Wax arches and comb walls in amber light; a colony that grew over a research station in 40 days and kept its schedule better than the staff did.',
    rooms: {
      entry: { names: ['Wax Gate', '{word} Comb', 'Outer Cells'], descriptions: ['Comb walls seal the entry arch to a 2-metre slot; 30 empty cells frame it, each the size of a door.', 'The first wax-choked hall, 40 cells deep, where the {word} was brought in.', 'Amber light comes through 12 wax windows; the floor is tacky and 3 lanterns hang in cocoons.'] },
      mid: { names: ['Brood Gallery', '{word} Nursery', 'Royal Cells'], descriptions: ['Sealed cells line the gallery 8 high; 9 of them are warm and 1 is open.', 'The nursery where the {word} was fed to the brood in 4 shifts a day.', 'Twelve larval cells stand open under a lantern the workers have waxed shut.'] },
      final: { names: ['Queen\'s Chamber', 'Heart of the {word}'], descriptions: ['The Anchor site sits under the queen\'s cell; the Guardian is the drone that never left her side.'] },
    },
    props: ['root_mass', 'lantern', 'pillar', 'crate', 'root_mass', 'monolith_shard'],
    enemies: { entry: ['swarmling', 'husk'], mid: ['spewer', 'swarmling'], final: ['guardian', 'warden'] },
    hazardChance: 0.6,
    hazardName: 'royal jelly pools that hold a boot fast',
    relics: [
      { title: 'Keeper\'s log', source: 'a station notebook waxed to the wall', text: 'Day 1: 400 workers, 1 queen, 3 of us. Day 20: 40,000 workers. Day 33: the comb reached the lab door and Pell stopped coming to breakfast. Day 40: 2 of us, and the {word} sealed into cell 9.' },
      { title: 'Feeding schedule', source: 'chalked on the nursery lintel', text: 'Brood fed at 6, 12, 18, 24. Ration per cell: 2 grams. The 18 feeding has 3 initials beside it for 39 days and 2 initials on day 40.' },
      { title: 'Cell 9 label', source: 'a brass tag pressed into warm wax', text: 'Cell 9, sealed day 40, contents: the {word}, 1 station ration card, 1 keeper\'s badge with the name filed off.' },
    ],
    remainsFlavor: 'in the comb',
    attunements: [
      { effectId: 'remains_charge', name: 'Royal Jelly', description: 'Every remains picked up feeds the ultimate 15 points of charge; the comb wastes nothing.' },
      { effectId: 'clear_surge', name: 'Comb Tithe', description: 'Clearing a hall pays the whole crew: 2 extra resources on every room clear.' },
    ],
  },
  {
    id: 'wasteland',
    keywords: ['wasteland', 'apocalypse', 'apocalyptic', 'bunker', 'radiation', 'radioactive', 'nuclear', 'scrap', 'rust', 'fallout', 'ruins', 'ruined', 'survivor', 'raider', 'mutant', 'wreckage', 'highway', 'dust', 'salvage', 'junkyard', 'scavenger', 'abandoned', 'derelict'],
    motifs: ['ruined_machinery', 'monoliths', 'cables', 'lanterns'],
    palette: { background: '#110e0a', floor: '#2c261c', floorAlt: '#352d21', wall: '#4a3f2e', wallEdge: '#d9a441', accent: '#ffb84d', accentSoft: '#7fd4a8', glow: '#ffd98c', hazard: '#9dff3a', text: '#f5ecd8' },
    adjectives: ['Rusted', 'Scoured', 'Dust-Choked', 'Buried', 'Irradiated'],
    nouns: ['Bunker', 'Highway', 'Scrapyard', 'Shelter', 'Silo'],
    taglines: ['A shelter for 200 that took in 900 and locked the door on day 3.', 'Forty kilometres of highway, 1 working lantern, and the counter still clicking.', 'Scrap towers 20 metres high, sorted by someone who never finished sorting.'],
    summary: 'Rust-red scrap monoliths, sagging power cables and one shelter door under a sky the colour of dust; the counters here still click at 40 a minute.',
    rooms: {
      entry: { names: ['Shelter Door', '{word} Checkpoint', 'Highway Cut'], descriptions: ['A 3-tonne blast door stands open 40 centimetres; 200 hand-prints in dust cover the outside.', 'The checkpoint where the {word} was searched, logged and let through, 900 times.', 'Wrecked haulers block the cut in a line of 12; the lantern on the seventh still burns.'] },
      mid: { names: ['Scrap Yard', '{word} Stacks', 'Ration Hall'], descriptions: ['Sorted scrap stands in 30 towers; the thirty-first is a pile with a shovel in it.', 'The stacks where the {word} was traded at 4 scrap to the tin.', 'Long tables for 200 and ration tins for 900, stacked by the door in a wall 2 metres high.'] },
      final: { names: ['Reactor Silo', 'Core of the {word}'], descriptions: ['The Anchor site is the silo floor; the Guardian is the warden who kept the door shut for 40 years.'] },
    },
    props: ['cable_bundle', 'crate', 'monolith_shard', 'terminal', 'lantern', 'pillar'],
    enemies: { entry: ['husk', 'swarmling'], mid: ['warden', 'spewer'], final: ['guardian', 'warden'] },
    hazardChance: 0.85,
    hazardName: 'glowing runoff that reads 40 on the counter',
    relics: [
      { title: 'Door log', source: 'a clipboard chained to the blast door', text: 'Day 1: 200 in, door open. Day 2: 600 in. Day 3: 900 in, door shut at 14:00 by order of Warden Osk. Day 4 to day 40: 0 in, 0 out, and the knocking logged at 3 a minute until day 9.' },
      { title: 'Ration tin', source: 'a tin with a message scratched inside the lid', text: 'One tin a day for 200 is 40 days. One tin a day for 900 is 9 days. Osk chose 40. This is the tin from day 41.' },
      { title: 'Counter reading', source: 'painted on the silo wall in metre-high figures', text: '40 a minute at the door, 400 at the stacks, 4,000 at the silo. Under the figures, smaller: the {word} went in at 4,000 and came back out.' },
    ],
    remainsFlavor: 'in the shelter',
    attunements: [
      { effectId: 'hazard_ward', name: 'Lead Lining', description: 'Glowing runoff and its spat bolts deal 40% less through the lead-lined coat.' },
      { effectId: 'clear_surge', name: 'Salvage Rights', description: 'Every cleared hall pays 2 extra resources; nothing here goes unsorted.' },
    ],
  },
  {
    id: 'frontier',
    keywords: ['western', 'frontier', 'saloon', 'cowboy', 'sheriff', 'outlaw', 'bandit', 'ranch', 'railroad', 'train', 'locomotive', 'prospector', 'gold', 'mine', 'mining', 'canyon', 'mesa', 'ghost town', 'wagon', 'homestead', 'gunslinger', 'rodeo'],
    motifs: ['lanterns', 'cables', 'monoliths', 'ruined_machinery'],
    palette: { background: '#160d08', floor: '#3d2a1a', floorAlt: '#473121', wall: '#5e4128', wallEdge: '#e0a45c', accent: '#ffc978', accentSoft: '#6fc3d8', glow: '#ffe1b0', hazard: '#ff6a3d', text: '#fff3e2' },
    adjectives: ['Dust-Red', 'Sundown', 'Claim-Staked', 'Rail-End', 'Hanging'],
    nouns: ['Claim', 'Rail-Head', 'Saloon', 'Mesa', 'Depot'],
    taglines: ['A rail-head town of 300 that struck the {word} and went quiet on the wire.', 'Twelve lanterns on the main street and 11 of them lit every night by nobody.', 'The train arrives at 6:10 with 40 cars and no driver.'],
    summary: 'Lantern-lit boardwalks, rail cables and claim-stake monoliths under a red mesa; a strike town of 300 whose telegraph went quiet on the ninth night.',
    rooms: {
      entry: { names: ['Depot Platform', '{word} Siding', 'Main Street'], descriptions: ['A 40-car train stands at the platform with its lanterns lit and 6 doors open.', 'The siding where the {word} was crated for the 6:10 to the coast.', 'Twelve lanterns hang along a boardwalk of 60 planks; the saloon doors swing in no wind.'] },
      mid: { names: ['Assay Office', '{word} Saloon', 'Claim Tunnels'], descriptions: ['Ore samples sit on the counter in 30 tin trays, 29 of them worthless and 1 of them warm.', 'The saloon where the {word} was weighed at 4 ounces to the drink.', 'Rail cables run into a mine cut 200 metres deep; every third lantern is out.'] },
      final: { names: ['The Mother Lode', 'Seam of the {word}'], descriptions: ['The Anchor site is the seam itself; the Guardian is the foreman who staked it and never came up.'] },
    },
    props: ['lantern', 'crate', 'cable_bundle', 'monolith_shard', 'terminal', 'pillar'],
    enemies: { entry: ['husk', 'lurker'], mid: ['sentinel', 'husk'], final: ['guardian', 'warden'] },
    hazardChance: 0.5,
    hazardName: 'blasting powder spilled along the rails',
    relics: [
      { title: 'Telegraph slip', source: 'the last slip on the depot spike', text: 'Night 9, 21:40. STRIKE CONFIRMED 4 OZ TO THE TON STOP SEND 40 MEN STOP. Under it, in pencil, the operator wrote: the 40 men are already here, and they came up out of the seam.' },
      { title: 'Assay ledger', source: 'open on the assay counter', text: 'Claim 12, the {word}: 4 ounces to the ton. Claim 13: 4 ounces. Claim 14: 4 ounces. Every claim on the page assays the same, in the same hand, and the hand gets steadier as it goes.' },
      { title: 'Saloon tab', source: 'chalked behind the bar', text: 'Foreman Dace: 12 drinks, paid in 4 ounces of the {word}. Sheriff Wenn: 9 drinks, paid the same. The last line is 300 drinks under one name, the town\'s, and it is marked paid.' },
    ],
    remainsFlavor: 'at the rail-head',
    attunements: [
      { effectId: 'first_strike', name: 'Quick Draw', description: 'The first strike on a fresh hostile lands 50% harder, the way the first shot decides a street.' },
      { effectId: 'clear_surge', name: 'Assay Bonus', description: 'Every cleared hall pays 2 extra resources; the claim assays 4 ounces to the ton.' },
    ],
  },
];
